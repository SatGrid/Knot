...
export function ChatShell({
  ...
  function chooseProfilePhoto(file?: File) {
    ...
    reader.onload = () => {
      ...
      image.onerror = () => setProfileError("That file could not be used as a photo.");
      image.onload = () => {
        const maxSide = 1200;
        ...
        setProfileAvatar(canvas.toDataURL("image/webp", 0.9));
      };
